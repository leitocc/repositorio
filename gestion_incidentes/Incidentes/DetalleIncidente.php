                            ...
                            if(mysql_errno() == 0){
                                ...
                                while ($row = mysql_fetch_array($query1)) { 
                                    ...
                                    if(!empty($compSI) && in_array($row['nombre'], $compSI)){
                                        ?>
                      <div style="float: left; height: 30px"><input type="checkbox" name="componente<?php echo $row['id'] ?>" id="comp<?php echo $row['id'] ?>" value="<?php echo $row['id'] ?>" class="componentes"/>
                          <label for="comp<?php echo $row['id'] ?>"><?php echo $row['nombre'] ?></label><br/></div>
                            <?php   }else{     ?>
                      <div style="float: left; height: 30px"><input type="checkbox" name="componente<?php echo $row['id'] ?>" id="comp<?php echo $row['id'] ?>" value="<?php echo $row['id'] ?>" disabled="true"/><label for="comp<?php echo $row['id'] ?>" style="color: red;"><?php echo $row['nombre'] ?></label><br/></div>
                                <?php 
