                ...
                <div class="main">
                    <div class="post">
                        <div style="clear: both">
                            ...
                            <li class="no_lista"><h3><a href="Marca/ABMMarca.php?modo=ins">Registrar Marca</a></h3></li>
                            <li class="no_lista"><h3><a href="Marca/BuscarMarca.php">Modificar Marca</a></h3></li>
                        </div>
                    </div>
                </div>
