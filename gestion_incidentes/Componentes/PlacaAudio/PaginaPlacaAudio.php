        ...
        <link rel="stylesheet" type="text/css" href="/incidentes/css/estilo.css" />
            <?php
                    if($_REQUEST['modo']=="ins"){
                        $titulo="Registrar Placa de audio";
                        $pagina="PlacaAudio.php?modo=ins";
                        $id = null;
                        $marca="Ninguno";
                        $mes="Ninguno";
                        $anio=2000;
                    ...
                    $consulta = mysql_query("SELECT c.id_componente as id ,c.descripcion as modelo, c.id_marca AS marca, c.nro_patrimonio as patrimonio, c.nro_serie as serie, c.anio_adquisicion as anio, c.mes_adquisicion as mes FROM componente c where c.id_sistema_informatico =".$_SESSION['si']." and c.id_tipo_componente = 10 AND c.baja=0 ");
                    if(mysql_num_rows($consulta) == 0){
                        ...
                        $titulo = "Modificar Placa de audio";
                        $pagina="PlacaAudio.php?modo=mod";
    ...
    <body id="top">
        ...
        <div style="width: 600px;">
          <table>
             ...
             <button class="submit" id="Registrar">Registrar</button>
