...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Pagina para registrar CPU nueva</title>
        ...
        <script>
            ...
            <?php
                    if($_REQUEST['modo']=="ins"){
                        $titulo="Registrar CPU";
                        $pagina="CpuPrimero.php?modo=ins";
                        $id = null;
                        $marca="Ninguno";
                        $mes="Ninguno";
                        $anio=2000;
                    ...
                    $consulta = mysql_query("SELECT c.id_componente as id ,c.descripcion as modelo, c.id_marca AS marca, c.nro_patrimonio as patrimonio, c.nro_serie as serie, c.anio_adquisicion as anio, c.mes_adquisicion as mes FROM componente c where c.id_sistema_informatico =".$_SESSION['si']." and c.id_tipo_componente = 4 AND c.baja=0 ");
                    if(mysql_num_rows($consulta) == 0){
                        ...
                        $pagina="CpuPrimero.php?modo=mod";
          ...
          <table width="500" border="1">
             ...
             <tr>
                 ...
                 <td><div name="inv"><input type="text" name="NroInventario" id="NroInventario" value="<?php echo $patrimonio?>"></div></td>
                            ...
                            <li><button class="submit">Registrar</button>
                                <button class="submit" id="Volver">Volver</button></li>
        </form>
                    </div>
                </div>
