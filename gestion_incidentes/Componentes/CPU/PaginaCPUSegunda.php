        ...
        <script>
            $(document).ready(function () {
                ...
                $("#agregarPlacaM").click(function (mievento) {
                    ...
                    window.location = '/incidentes/Componentes/PlacaMadre/PaginaPlacaMadre.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarPlacaM").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/PlacaMadre/PaginaPlacaMadre.php?modo=mod';
                });

                $("#quitarPlacaM").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Placa Madre del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/PlacaMadre/Placa.php?modo=del';
                    }
                });

                $("#agregarPlacaA").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/PlacaAudio/PaginaPlacaAudio.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarPlacaA").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/PlacaAudio/PaginaPlacaAudio.php?modo=mod';
                });

                $("#quitarPlacaA").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Placa de Audio del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/PlacaAudio/PlacaAudio.php?modo=del';
                    }
                });

                $("#agregarPlacaV").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/PlacaVideo/PaginaPlacaVideo.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarPlacaV").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/PlacaVideo/PaginaPlacaVideo.php?modo=mod';
                });

                $("#quitarPlacaV").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Placa de Video del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/PlacaVideo/PlacaVideo.php?modo=del';
                    }
                });

                $("#agregarPlacaR").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/PlacaRed/PaginaPlacaRed.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarPlacaR").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/PlacaRed/PaginaPlacaRed.php?modo=mod';
                });

                $("#quitarPlacaR").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Placa de Red del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/PlacaRed/PlacaRed.php?modo=del';
                    }
                });
<?php /*
  ...
  //                }); */ ?>
                $("#agregarDisco1").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/DiscoDuro1/PaginaDiscoDuro.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarDisco1").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/DiscoDuro1/PaginaDiscoDuro.php?modo=mod&idComponente=' + $("#idComponenteDisco1").val();
                });

                $("#quitarDisco1").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar el Disco Rigido del SI ?")) {
                        window.location = '/incidentes/Componentes/DiscoDuro1/DiscoDuro.php?modo=del&idComponente=' + $("#idComponenteDisco1").val();
                    }
                });
                $("#agregarDisco2").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/DiscoDuro2/PaginaDiscoDuro.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarDisco2").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/DiscoDuro2/PaginaDiscoDuro.php?modo=mod&idComponente=' + $("#idComponenteDisco2").val();
                });

                $("#quitarDisco2").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar el Disco Rigido del SI ?")) {
                        window.location = '/incidentes/Componentes/DiscoDuro2/DiscoDuro.php?modo=del&idComponente=' + $("#idComponenteDisco2").val();
                    }
                });

                $("#agregarMemoria1").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/MemoriaRam1/PaginaMemoriaRam.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarMemoria1").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/MemoriaRam1/PaginaMemoriaRam.php?modo=mod&idComponente=' + $("#idComponenteRam1").val();
                });

                $("#quitarMemoria1").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Memoria RAM del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/MemoriaRam1/Memoria.php?modo=del&idComponente=' + $("#idComponenteRam1").val();
                    }
                });
                $("#agregarMemoria2").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/MemoriaRam2/PaginaMemoriaRam.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarMemoria2").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/MemoriaRam2/PaginaMemoriaRam.php?modo=mod&idComponente=' + $("#idComponenteRam2").val();
                });

                $("#quitarMemoria2").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Memoria RAM del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/MemoriaRam2/Memoria.php?modo=del&idComponente=' + $("#idComponenteRam2").val();
                    }
                });
                $("#agregarMemoria3").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/MemoriaRam3/PaginaMemoriaRam.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarMemoria3").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/MemoriaRam3/PaginaMemoriaRam.php?modo=mod&idComponente=' + $("#idComponenteRam3").val();
                });

                $("#quitarMemoria3").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Memoria RAM del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/MemoriaRam3/Memoria.php?modo=del&idComponente=' + $("#idComponenteRam3").val();
                    }
                });
                $("#agregarMemoria4").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/MemoriaRam4/PaginaMemoriaRam.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarMemoria4").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/MemoriaRam4/PaginaMemoriaRam.php?modo=mod&idComponente=' + $("#idComponenteRam4").val();
                });

                $("#quitarMemoria4").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Memoria RAM del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/MemoriaRam4/Memoria.php?modo=del&idComponente=' + $("#idComponenteRam4").val();
                    }
                });

                $("#agregarProcesador").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/Microprocesador/PaginaProcesador.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarProcesador").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/Microprocesador/PaginaProcesador.php?modo=mod';
                });

                $("#quitarProcesador").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar el Microprocesador del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/Microprocesador/Procesador.php?modo=del';
                    }
                });

                $("#agregarLectora").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/Lectora/PaginaLectora.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarLectora").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/Lectora/PaginaLectora.php?modo=mod';
                });

                $("#quitarLectora").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Lectora del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/Lectora/Lectora.php?modo=del';
                    }
                });

                $("#agregarFuente").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/Fuente/PaginaFuente.php?modo=ins&idSub=<?php echo $componente ?>';
                });

                $("#modificarFuente").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/Componentes/Fuente/PaginaFuente.php?modo=mod';
                });

                $("#quitarFuente").click(function (mievento) {
                    mievento.preventDefault();
                    if (confirm("¿Está seguro que desea quitar la Fuente del SI <?php echo $SI ?>?")) {
                        window.location = '/incidentes/Componentes/Fuente/Fuente.php?modo=del';
                    }
                });

                $("#Volver").click(function (mievento) {
                    mievento.preventDefault();
                    window.location = '/incidentes/SistemaInformatico/ModificarComponentesSI.php';
                });
            });
        </script>
    </head>
