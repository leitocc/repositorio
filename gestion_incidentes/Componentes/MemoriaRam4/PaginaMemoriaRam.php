        ...
        <link rel="stylesheet" type="text/css" href="/incidentes/css/estilo.css" />
            <?php
                    if($_REQUEST['modo']=="ins"){
                        ...
                        $querycons = "SELECT c.id_componente as id ,c.descripcion as modelo, "
                            . "c.id_marca AS marca, c.nro_patrimonio as patrimonio, c.nro_serie as serie, "
                            . "c.anio_adquisicion as anio, c.mes_adquisicion as mes "
                            . "FROM componente c where c.id_sistema_informatico =".$_SESSION['si']." "
                            . "and c.id_tipo_componente = 5 AND c.baja=0 AND c.id_componente = ".$idComponente;
                    //echo $querycons."<br/>";
                    $consulta = mysql_query($querycons);
                    ...
                    while ($row = mysql_fetch_array($consulta)) { 
                        //echo "entro!!<br/>";
                            ...
                            $queryCons3 = "SELECT  D.valor_alfanumerico as valor "
                                    ...
                                    . "and D.id_descipcion = 4 and C.baja=0 "
                                    . "and C.id_tipo_componente=5 AND C.id_componente = ".$idComponente;
                            $consulta3 = mysql_query($queryCons3);
                            //echo $queryCons3."<br/>";
                         ...
                         $consulta2 = mysql_query("SELECT D.valor as valor "
                                 . "FROM detalle_componente D inner join componente C on (D.id_componente=C.id_componente) "
                                 . "where C.id_sistema_informatico = ".$_SESSION['si']." and D.id_descipcion = 2 "
                                 . "and C.baja=0 and C.id_tipo_componente=5 AND C.id_componente = ".$idComponente);
                        //echo $consulta2."<br/>";
                        ...
                        $consulta = mysql_query("SELECT D.valor as valor "
                                . "FROM detalle_componente D inner join componente C on (D.id_componente=C.id_componente) "
                                . "where C.id_sistema_informatico = ".$_SESSION['si']." and D.id_descipcion = 1 "
                                . "and C.baja=0 and C.id_tipo_componente=5 AND C.id_componente = ".$idComponente);
                        //echo $consulta."<br/>";
                         if(mysql_num_rows($consulta) == 0){
                            $frec="";
