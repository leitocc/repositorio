        ...
        <link rel="stylesheet" type="text/css" href="/incidentes/css/estilo.css" />
            <?php
                    if($_REQUEST['modo']=="ins"){
                        $titulo="Registrar Placa de video";
                        $pagina="PlacaVideo.php?modo=ins";
                        $id = null;
                        $marca="Ninguno";
                        $mes="Ninguno";
                        $anio=2000;
                    ...
                    $consulta = mysql_query("SELECT c.id_componente as id ,c.descripcion as modelo, c.id_marca AS marca, c.nro_patrimonio as patrimonio, c.nro_serie as serie, c.anio_adquisicion as anio, c.mes_adquisicion as mes FROM componente c where c.id_sistema_informatico =".$_SESSION['si']." and c.id_tipo_componente = 8 AND c.baja=0 ");
                    if(mysql_num_rows($consulta) == 0){
                        ...
                        $titulo = "Modificar Placa de video";
                        $pagina="PlacaVideo.php?modo=mod";
                    while ($row = mysql_fetch_array($consulta)) { 
                            ...
                            $consulta2 = mysql_query("SELECT D.valor as valor FROM detalle_componente D inner join componente C on (D.id_componente=C.id_componente) where C.id_sistema_informatico = ".$_SESSION['si']." and D.id_descipcion = 2 and C.baja=0 and C.id_tipo_componente=8");
        ...
        <div id="site">
          ...
          <table>
             ...
             <tr>
                 ...
                 <td><input type="text" name="memoria" id="capac" value="<?php echo $capac?>" required> MB</td>
             </tr>
            </table>
