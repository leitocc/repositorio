    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/incidentes/css/estilo.css" />
                    ...
                    if($_REQUEST['modo']=="ins"){
                        $titulo="Registrar monitor";
                        $pagina="Monitor.php?modo=ins";
                        $id = null;
                        $marca="Ninguno";
                        $mes="Ninguno";
                        $anio=2000;
                        ...
                        $consulta = mysql_query("SELECT c.id_componente as id ,c.descripcion as modelo, c.id_marca AS marca, c.nro_patrimonio as patrimonio, c.nro_serie as serie, c.anio_adquisicion as anio, c.mes_adquisicion as mes FROM componente c where c.id_sistema_informatico =".$_SESSION['si']." and c.id_tipo_componente = 1 AND c.baja=0 ");
                        ...
                        $consulta2 = mysql_query("SELECT D.valor as valor FROM detalle_componente D inner join componente C on (D.id_componente=C.id_componente) where C.id_sistema_informatico = ".$_SESSION['si']." and D.id_descipcion = 5 and C.baja=0 and C.id_tipo_componente=1");
                        ...
                        $consulta3 = mysql_query("SELECT  D.valor_alfanumerico as valor FROM detalle_componente D inner join componente C on (D.id_componente=C.id_componente) where C.id_sistema_informatico = ".$_SESSION['si']." and D.id_descipcion = 3 and C.baja=0 and C.id_tipo_componente=1");
        ...
        <div id="site">
          ...
          <table>
              <tr>
                  ...
                  <td><input name="SI" id="SI" type="text" maxlength="20" readonly="true" value="<?php echo $_SESSION['si']?>" required/>
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                      <?php 
                      $consulta = mysql_query("select * from marca"); ?>
          ...
          <tr>
              <td>Medida (*)</td>
              <td><input type="text" id="medida" name="medida" value="<?php echo $med?>" required/> Pulgadas</td>
              
          </tr>
        </table>
                    </div>
                      <li><button class="submit" name="Registrar">Registrar</button><button class="submit" name="volver" id="Volver">Volver</button></li>
                    </form>
          
                        <input type="hidden" value="<?php echo $_REQUEST['modo'] ?>" name="modo"/>
