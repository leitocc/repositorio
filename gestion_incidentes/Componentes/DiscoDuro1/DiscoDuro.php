...
//            $consulta = mysql_query("SELECT id_componente AS id "
//                    . "FROM componente where id_tipo_componente = 6 and baja=0 "
//                    . "and id_sistema_informatico=".$_SESSION['si']." AND c.id_componente = ".$idComponente);
...
//                    . "where id_tipo_componente = 6 and id_sistema_informatico=".$_SESSION['si']." "
//                    . "AND c.id_componente = ".$idComponente);
//            while ($row = mysql_fetch_array($consulta)) {  
//            $idComponente =$row['id'];}
