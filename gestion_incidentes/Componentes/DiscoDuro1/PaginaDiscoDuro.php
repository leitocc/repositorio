    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/incidentes/css/estilo.css" />
            <?php
                    ...
                    $consulta = mysql_query("SELECT c.id_componente as id ,c.descripcion as modelo, "
                            ...
                            . "and c.id_tipo_componente = 6 AND c.baja=0 AND c.id_componente = ".$idComponente);
                    ...
                    while ($row = mysql_fetch_array($consulta)) { 
                            ...
                            $consulta3 = mysql_query("SELECT  D.valor_alfanumerico as valor "
                                    . "FROM detalle_componente D inner join componente C on (D.id_componente=C.id_componente) "
                                    . "where C.id_sistema_informatico = ".$_SESSION['si']." and D.id_descipcion = 3 "
                                    . "and C.baja=0 and C.id_tipo_componente=6 AND c.id_componente = ".$idComponente);
